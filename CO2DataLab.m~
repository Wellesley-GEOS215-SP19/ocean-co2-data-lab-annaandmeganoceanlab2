...
%%%%%%%%%%%%
%Ocean station BATS 32^0 50' N, 64^0 10' W -->latstn 32, lonstn 60+180=240?

plot(squeeze(SStemp(28,8,:))) %sea surface temp

hold on
plot(squeeze(SWco2(28,8,:))) %seawater pCO2

hold on
plot(squeeze(pCO2_T(28, 8, :))) %seawater pCO2 temp effects

hold on
plot(squeeze(pCO2_BP(28,8,:))) %seawater pCO2 temp effects
...
%%
%%%%%%%%%%%%%%%%
%Ocean Station Papa (50 N lat / 145 W lon --> latstn 48, lonstn 145 + 180 = 325?? )
...
%%
%%%%%%%%%%%%%%%%%%
%ROSS (76 S lat / 177.5 W lon --> latstn -76, lonstn 175 + 180 = 355??)
% plot(squeeze(SStemp(28,8,:)))
% 
% hold on
% plot(squeeze(SWco2(28,8,:)))
